...
<svelte:head>
	...
	<meta
		name="description"
		content="Create a new Blog App account to access your dashboard and manage your posts."
	/>
</svelte:head>
...
<form class="flex flex-col gap-6" method="post" use:enhance>
	...
	<div class="grid gap-6">
		...
		<div class="grid gap-3">
			...
			<Input id="username-{id}" name="username" type="text" placeholder="username" required />
		</div>
		<div class="grid gap-3">
			...
			<Input id="password-{id}" name="password" placeholder="password" type="password" required />
		</div>
	...
	<div class="text-center text-sm">
		...
		<a href="{base}/login" class="underline underline-offset-4"> Sign in </a>
	</div>
</form>
